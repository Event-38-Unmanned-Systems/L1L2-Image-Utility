namespace E38_Delay_Utility
{
    partial class Delay
    {
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Delay));
            this.button1 = new System.Windows.Forms.Button();
            this.comboBox1 = new System.Windows.Forms.ComboBox();
            this.textBox1 = new System.Windows.Forms.TextBox();
            this.label1 = new System.Windows.Forms.Label();
            this.Pos_FilePath = new System.Windows.Forms.Label();
            ...
            this.toolTip1.SetToolTip(this.comboBox1, "Select a preset camera or add a custom camera. Add a camera by entering a name an" +
        "d offset then clicking process.");
            ...
            this.textBox1.Text = "Camera offset (seconds)";
            this.textBox1.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
            this.toolTip1.SetToolTip(this.textBox1, "Camera offset in seconds. Use negative numbers in cases when the pulse arrives af" +
        "ter the sensor is exposed.");
            // 
            // label1
            // 
            ...
            this.toolTip1.SetToolTip(this.label2, "Select the .SBP file located inside the Rover directory.");
            // 
            // label3
            // 
            ...
            this.toolTip1.SetToolTip(this.label3, "Select a preset camera or add a custom camera. Add a camera by entering a name an" +
        "d offset then clicking process.");
            // 
            // label4
            // 
            ...
            this.toolTip1.SetToolTip(this.label4, "Camera offset in seconds. Use negative numbers in cases when the pulse arrives af" +
        "ter the sensor is exposed.");
            // 
            // Delay
            // 
            ...
            this.Controls.Add(this.Pos_FilePath);
            ...
            this.Name = "Delay";
            this.Text = "Intellishoot Format Utility";
        ...
        private System.Windows.Forms.Label Pos_FilePath;
